...
export const EditModal = ({ imageUrl, setShowModal, dimen , name}) => {
  ...
  function change_background(url) {
    $("#canvas").css("background-image", `url('${BASE_URL + url}')`);
  ...
  function change_backgroud_color(e) {
    console.log(e);
    $("#canvas").css("background-image", `linear-gradient(${e},${e})`);
  ...
  function save() {
    ...
    backCanvas.width = myCanvas.current.width;
    backCanvas.height = myCanvas.current.height;
    var backCtx = backCanvas.getContext("2d");

    backCtx.drawImage(myCanvas.current, 0, 0);
    console.log(backCtx);
    ...
    if (background !== "") {
      ...
      backgroundImg.onload = function () {
        ...
        console.log(ctx);
        var dataURL = myCanvas.current.toDataURL("image/png", 1.0);
      ...
      ctx.clearRect(0, 0, myCanvas.current.width, myCanvas.current.height);
      ctx.beginPath();
      ctx.rect(0, 0, myCanvas.current.width, myCanvas.current.height);
      ...
      console.log(ctx);
      const dataURL = myCanvas.current.toDataURL("image/png", 1.0);
    ...
    <div className="edit-modal">
      ...
      <div className="under-edit-modal container-fluid p-2">
        <div className="row justify-content-between gx-0">
          <div className="col-lg-7 col-md-7 col-sm-12 col-12 px-2 text-center">
            {/* Header */}
            <div className="d-flex justify-content-between mb-3">
              ...
              <div className="d-flex justify-content-center">
                <button
                  className="btn btn-light shadow mx-1"
                  onClick={zoom_out}
                >
                ...
                <button className="btn btn-light shadow mx-1" onClick={zoom_in}>
                  <i className="fa-solid fa-plus"></i>
                </button>
              </div>

              <div className="d-flex justify-content-center">
                <button className="btn btn-light shadow mx-1">
            ...
            <button
              onClick={save}
              className="rounded-5 w-50  mt-4 btn mx-auto  btn-primary px-4  btn-lg"
            >
          ...
          <div className="col-lg-5 col-md-5 col-sm-12 col-12 text-center">
            <div className="d-flex">
              <h4
                className={
                  !toolTab
                    ? `p-3 w-100 text-secondary text-center tool-tab-active tool-tab`
                    : `p-3 w-100 text-secondary text-center tool-tab`
                }
                onClick={() => {setToolTab(false); setEraser("");}}
              >
              ...
              <h4
                ...
                onClick={() => {setToolTab(true); setEraser("eraser"); console.log(mode.current)}}
              >
                <i className="fa-solid fa-paintbrush"></i> Erase Tool
              </h4>
            </div>
            {!toolTab ? (
              <div className="tool-tab-content text-center">
                <div className="d-flex bg-white  p-3 justify-content-center">
                  <button
                    className={
                      !backgroundTab
                        ? "btn btn-secondary mx-1 shadow"
                        : "btn btn-light mx-1 shadow"
                    }
                    onClick={() => setBackgroundTab(false)}
                  >
                    <i className="far fa-images"></i> Photo
                  </button>
                  <button
                    className={
                      backgroundTab
                ...
                {!backgroundTab ? (
                  <>
                    ...
                    <div className="col-md-12  p-1  text-center py-2">
                      <div
                        className="bg-secondary p-2 rounded mb-2 btn w-100"
                        onClick={selectFile}
                      >
                        ...
                        <>
                          {backgroundImages.length > 0 ? (
                            backgroundImages.map((e) => (
                              <div
                                key={e.id}
                                className="col-md-4 p-1  text-center btn py-2"
                                onClick={() => change_background(e.image)}
                              >
                                <div className=" p-2 rounded">
                                  <img
                                    src={BASE_URL + e.image}
                                    className="w-100 img-fuild"
                                    alt=""
                                  />
                                  <br />
                                </div>
                    ...
                    <div className="row gx-0  p-5 justify-content-center">
                      {colorList.map((e) => (
                        <div
                          key={e}
                          className="col-md-4 p-1  text-center btn py-2"
                          onClick={() => change_backgroud_color(e)}
                        >
                          <div
                            className=" p-2 rounded w-100"
                            style={{ backgroundColor: e, height: "100px" }}
                          ></div>
                        </div>
                      ))}
                    </div>
              ...
              <div className="tool-tab-content p-5">
                ...
                <button className="btn btn-light shadow mx-1" disabled>
                  {width}%
                </button>
                <button
                  className="btn btn-light shadow mx-1"
                ...
                <div
                  className="col-5 p-5 mx-auto mt-1 bg-white  text-center border"
                  style={{
                    display: "flex",
