...
export const Footer = () => {
  return (
    <>
    <div className='footer container-fluid mt-5' style={{"minHeight":'40vh'}}>
      ...
      <div className='br-footer-menu col-lg-12'>
        <ul className="text-light mt-2">
          <li><Link className='text-decoration-none ' to="/privacy-policy"><h6 className=' footer-nav-link'>Privacy Policy</h6></Link></li>
          <li><Link className='text-decoration-none ' to="/terms-conditions"><h6 className=' footer-nav-link'>Terms &amp; Conditions</h6></Link></li>
          <li><Link className='text-decoration-none ' to="/about-us"><h6 className=' footer-nav-link'>About Us</h6></Link></li>
          <li><Link className='text-decoration-none ' to="/contact-us"><h6 className=' footer-nav-link'>Contact Us</h6></Link></li>
