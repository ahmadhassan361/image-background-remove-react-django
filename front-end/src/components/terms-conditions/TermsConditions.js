      ...
      <div className="container my-5">
          <div className="row justify-content-center">
            <div className="col-md-7 shadow rounded p-3 p-lg-5 text-start">
              ...
              <h3 className="fw-bold mt-2">Interpretation and Definitions</h3>
              <h5 className="fw-bold mt-2">Interpretation</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
              ...
              <h5 className="fw-bold mt-2">Definitions</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
For the purposes of these Terms and Conditions:
              ...
              <h5 className="fw-bold mt-2">Acknowledgment</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
Your access to and use of the Service is also conditioned on your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes our policies and procedures on the collection, use and disclosure of your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.
              ...
              <h5 className="fw-bold mt-2">Links to Other Websites</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
We strongly advise you to read the terms and conditions and privacy policies of any third-party web sites or services that you visit.
              ...
              <h5 className="fw-bold mt-2">Termination</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
Upon termination, your right to use the Service will cease immediately.
              ...
              <h5 className="fw-bold mt-2">Limitation of Liability</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
<br /> Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the above limitations may not apply. In these states, each party's liability will be limited to the greatest extent permitted by law.
              ...
              <h5 className="fw-bold mt-2">"AS IS" and "AS AVAILABLE" Disclaimer</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
<br /> Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply to you. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law.
              ...
              <h5 className="fw-bold mt-2">Governing Law</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.
              ...
              <h5 className="fw-bold mt-2">Disputes Resolution</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
If you have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
              ...
              <h5 className="fw-bold mt-2">For European Union (EU) Users</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
If you are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.
              ...
              <h5 className="fw-bold mt-2">United States Legal Compliance</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
              ...
              <h5 className="fw-bold mt-2">Severability and Waiver</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
              ...
              <h5 className="fw-bold mt-2">Waiver</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.
              ...
              <h5 className="fw-bold mt-2">Translation Interpretation</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
              ...
              <h5 className="fw-bold mt-2">Changes to These Terms and Conditions</h5>
              <p
                className="lead p-0"
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
...
By continuing to access or use Our Service after those revisions become effective, you agree to be bound by the revised terms. If you do not agree to the new terms, in whole or in part, please stop using the website and the Service.
              ...
              <p
                ...
                style={{ fontSize: "16px", textAlign: "justify" }}
              >
                <b>If you have any questions about these Terms and Conditions, You can contact us:</b>
              ...
              <ul>
                ...
                <li>By sending a message to: <a href="mailto:backgroundremovercc@gmail.com">backgroundremovercc@gmail.com</a></li>
